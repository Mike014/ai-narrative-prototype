...
MONOLOGO = (
    "Sai, spesso la verità è un verme che ti striscia sulla nuca, "
    "ti fa tremare e riduce il cuore a un giocattolo isterico, "
    "quello che ti fa battere il cuore come se avessi una cotta per qualcuno. "
    "Tachicardia sul punto di rottura, specchio lucido del tuo essere. "
    "Senza accettazione l’infezione diventa cronica: uova nella corteccia del pensiero, "
    "microfori nel cranio, e la larva, quando esce, decide al posto tuo."
)

MP3_FILE = GEN_DIR / "La_VeRiT4.mp3"
WAV_FILE = GEN_DIR / "La_VeRiT4.wav"   # fallback caricato da pygame
